                ...
                <div class="col-xs-6 col-xs-offset-3">
	                ...
	                <?php if(isset($searchQuestion) && count($searchQuestion)): ?>
	                	...
	                	<?php foreach($searchQuestion as $value): ?>
							<div class="mb-2"><a href="question_disp.php? question_id=<?php echo $value['question_id']?>">題名：<?php echo htmlspecialchars($value['title']) ?></a></div>
							<div><img src="../../top/img/<?php echo $value['icon']; ?>"></div>
	                		<div class="small mb-2"><?php echo htmlspecialchars($value['name']) ?>さん</div>
	                		<div>カテゴリ：<?php echo htmlspecialchars($value['category_name']) ?></div>
	                		<div>本文：<?php echo htmlspecialchars($value['message']) ?></div>
	                		<div class="small">日時：<?php echo htmlspecialchars($value['post_date']) ?></div>
	                	<?php endforeach; ?>
	                <!--ヒットする結果がなかった場合-->
